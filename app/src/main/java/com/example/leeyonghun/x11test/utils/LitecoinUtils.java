...
import org.bitcoinj.params.LitecoinNetParameters;
import org.bitcoinj.params.LitecoinTestNetParameters;
...
public class LitecoinUtils implements UtilsImpl{
    private  final String TAG = "BitcoinUtils";
    public Context params = new Context(AppApplication.isMainnet ? LitecoinNetParameters.get() : LitecoinTestNetParameters.get());
    private static LitecoinUtils instance = new LitecoinUtils();



    private LitecoinUtils(){}

    public static LitecoinUtils getInstance()
    {
        return instance;
    }
